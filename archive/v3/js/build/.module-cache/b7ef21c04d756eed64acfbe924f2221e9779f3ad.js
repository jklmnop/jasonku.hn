...
var Mind = React.createClass({displayName: 'Mind',
	text: 'I undergrad-ed at an art school, then I grad-ed at a technology school, <abbr title="and per se and" className="amp">&amp;</abbr> now I\'m self-educating.',
	render: function(){
		return (
			React.DOM.p(null, this.text.toString())
		);
	}
});
